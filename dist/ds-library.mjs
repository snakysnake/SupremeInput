...
import { defineComponent, openBlock, createElementBlock, toDisplayString, createCommentVNode, createElementVNode, Fragment, renderList } from 'vue';
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        ? (openBlock(), createElementBlock("div", _hoisted_7, [
            ...
            (_ctx.step > 0)
              ? (openBlock(), createElementBlock("div", _hoisted_9, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.amountOfDivisionSteps, (index) => {
    ...
    (_ctx.description.length > 0)
      ? (openBlock(), createElementBlock("p", {
        ...
        }, toDisplayString(_ctx.description), 9 /* TEXT, PROPS */, _hoisted_20))
      : createCommentVNode("v-if", true)
  ]))
}
...
export { index as SupremeLabel, DSLibrary as default };
